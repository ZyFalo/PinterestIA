...
export default function LoginPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setError(e.detail || "Error al iniciar sesión");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1713425887916-111e58eba679?w=1200&h=1800&fit=crop')",
        }}
      >
      ...
      <div className="w-1/2 h-screen flex items-center justify-center px-[120px] py-10">
        <div className="w-full max-w-[480px] bg-white rounded-2xl border border-[#F0F0F0] p-12 flex flex-col gap-7">
          {/* Header */}
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex justify-end">
              <button className="text-[13px] text-accent-red hover:underline">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-center text-[14px] text-text-secondary">
              ¿No tienes cuenta?{" "}
              <Link href={ROUTES.registro} className="text-accent-red hover:underline">
                Regístrate
              </Link>
            </p>
          </div>
