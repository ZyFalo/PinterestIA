...
- "name": nombre descriptivo en español (ej: "Blazer azul marino", "Jeans slim fit")
- "type": categoría, DEBE ser una de: "Top", "Bottom", "Vestido", "Abrigo", "Calzado", "Accesorio"
- "color": color principal (ej: "negro", "azul marino", "blanco roto")
...
- Sé específico en los nombres (no solo "camisa", sino "camisa de lino blanca")
